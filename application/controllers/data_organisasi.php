			...
			else
			{
				...
				if($st=="edit")
				{
					...
					if(!empty($_FILES['userfile']['name']))
					{
						...
						$config['upload_path']	= "./asset/foto_organisasi/";
						...
						if ($this->upload->do_upload("userfile")) {
							...
							/* PATH */
							$source             = "./asset/foto_organisasi/".$data['file_name'] ;
							$destination_thumb	= "./asset/foto_organisasi/thumb/" ;
							$destination_medium	= "./asset/foto_organisasi/medium/" ;
