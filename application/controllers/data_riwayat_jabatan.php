	...
	*/
	...
	public function simpan()
	{
		if($this->session->userdata('logged_in')!="" && $this->session->userdata('stts')=="administrator")
		{
			...
			$this->form_validation->set_rules('id_eselon', 'Pangkat', 'trim|required');
			$this->form_validation->set_rules('tmt_eselon', 'Tmt Pangkat', 'trim|required');
			...
			else
			{
				...
				if($st=="edit")
				{
					...
					if(!empty($_FILES['userfile']['name']))
					{
						...
						$config['upload_path']	= "./asset/foto_jabatan/";
						...
						if ($this->upload->do_upload("userfile")) {
							...
							/* PATH */
							$source             = "./asset/foto_jabatan/".$data['file_name'] ;
							$destination_thumb	= "./asset/foto_jabatan/thumb/" ;
							$destination_medium	= "./asset/foto_jabatan/medium/" ;
