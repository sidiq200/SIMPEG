			...
			else
			{
				...
				if($st=="edit")
				{
					...
					if(!empty($_FILES['userfile']['name']))
					{
						...
						$config['upload_path']	= "./asset/foto_gaji/";
						...
						if ($this->upload->do_upload("userfile")) {
							...
							/* PATH */
							$source             = "./asset/foto_gaji/".$data['file_name'] ;
							$destination_thumb	= "./asset/foto_gaji/thumb/" ;
							$destination_medium	= "./asset/foto_gaji/medium/" ;
