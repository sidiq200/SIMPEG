...
<div class="well">
	...
	?>
      <tr>
        ...
        <td><?php echo $dp['ura']; ?>&nbsp;<?php echo $dp['gol']; ?><BR> <?php $tanggal_sk = date('d F Y', strtotime('+2 years', strtotime($dp['tanggal_sk_pangkat']))); echo $tanggal_sk;?><BR></td>
      </tr>
	 <?php
	 		$no++;
	 	}
